...
var $author$project$Model$iniMeanPosition = {altitude: 0, east: 0, fix: false, imgUrl: './img/Landesmuseum.jpg', latitude: 0, longitude: 0, mdDescription: '', north: 0, refId: '', title: ''};
...
var $author$project$Model$iniSettings = {addingReference: false, checkDistance: true, meanMeasures: 5, showDiagram: false};
...
var $author$project$Model$platzspitz = _Utils_Tuple2(
	'1Landesmuseum',
	{altitude: 408.36, east: 2683256.46, fix: true, imgUrl: './img/Landesmuseum.jpg', latitude: 47.378631, longitude: 8.541108, mdDescription: 'Weitere Informationen finden Sie unter [Kontrollpunkt Landesmuseum](https://www.zh.ch/de/planen-bauen/geoinformation/geodaten/koordinatensystem.html#273464403 "Infos zu Kontrollpunkt")', north: 1248117.48, refId: '1Landesmuseum', title: 'Kontrollpunkt für mobile Geräte beim Landesmuseum'});
...
var $author$project$Model$WindowSizeUpdated = F2(
	function (a, b) {
		return {$: 'WindowSizeUpdated', a: a, b: b};
	});
...
var $author$project$Main$buildOlMapConfig = function (model) {
	...
	var getCenter = checkDistance ? _Utils_Tuple2(refPos.east, refPos.north) : _Utils_Tuple2(model.myLocation.east, model.myLocation.north);
...
var $author$project$Main$getMeanPosition = F2(
	function (count, measurements) {
		var mNorth = A3(
			$elm$core$List$foldl,
			function (a) {
				return $elm$core$Basics$add(a.north);
			},
			0,
		...
		var mLongitude = A3(
			$elm$core$List$foldl,
			function (a) {
				return $elm$core$Basics$add(a.longitude);
			},
			0,
			A2($elm$core$List$take, count, measurements)) / $elm$core$List$length(
			A2($elm$core$List$take, count, measurements));
		var mLatitude = A3(
			$elm$core$List$foldl,
			function (a) {
				return $elm$core$Basics$add(a.latitude);
			},
			0,
			A2($elm$core$List$take, count, measurements)) / $elm$core$List$length(
			A2($elm$core$List$take, count, measurements));
		var mEast = A3(
			$elm$core$List$foldl,
			function (a) {
				return $elm$core$Basics$add(a.east);
			},
			0,
			A2($elm$core$List$take, count, measurements)) / $elm$core$List$length(
			A2($elm$core$List$take, count, measurements));
...
var $author$project$Main$wgsToMyLocation = F2(
	function (model, location) {
		...
		var movDegree = function () {
			var _v3 = location.movingDegrees;
			if (_v3.$ === 'Just') {
				var m = _v3.a;
				return $elm$core$Maybe$Just(
		...
		var altiAcc = function () {
			var _v2 = location.accuracyAltitude;
			if (_v2.$ === 'Just') {
				var a = _v2.a;
				return $elm$core$Maybe$Just(
...
var $author$project$Main$getLocationModel = F2(
	function (model, location) {
		...
		var newMeasurements = A2($elm$core$List$cons, myloc, model.measurements);
		var newMeanPosition = A2($author$project$Main$getMeanPosition, model.settings.meanMeasures, newMeasurements);
		return _Utils_update(
			model,
			{
				error: '',
				meanPosition: newMeanPosition,
				meanPositions: A2($elm$core$List$cons, newMeanPosition, model.meanPositions),
						...
						return function (title) {
							return function (mdDescription) {
								return function (imgUrl) {
									return function (fix) {
										return {altitude: altitude, east: east, fix: fix, imgUrl: imgUrl, latitude: latitude, longitude: longitude, mdDescription: mdDescription, north: north, refId: refId, title: title};
									};
								};
							};
						};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'checkDistance',
					$elm$json$Json$Encode$bool($.checkDistance)),
					_Utils_Tuple2(
					'measurements',
					$elm$json$Json$Encode$list(
						function ($) {
							return $elm$json$Json$Encode$object(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'accuracyPos',
										$elm$json$Json$Encode$float($.accuracyPos)),
										_Utils_Tuple2(
										'altitude',
										function ($) {
											return A3($elm$core$Maybe$destruct, $elm$json$Json$Encode$null, $elm$json$Json$Encode$float, $);
										...
										_Utils_Tuple2(
										'locationKey',
										$elm$json$Json$Encode$string($.locationKey)),
										_Utils_Tuple2(
										'longitude',
									...
									return $elm$json$Json$Encode$object(
										_List_fromArray(
											[
												...
												_Utils_Tuple2(
												'mdDescription',
												$elm$json$Json$Encode$string($.mdDescription)),
												_Utils_Tuple2(
												'north',
												$elm$json$Json$Encode$float($.north)),
												_Utils_Tuple2(
					...
					_Utils_Tuple2(
					'zoom',
					$elm$json$Json$Encode$float($.zoom))
				]));
	});
...
var $author$project$Main$toggleAddReference = function (settings) {
	return _Utils_update(
		settings,
		{addingReference: !settings.addingReference});
};
			...
			case 'WindowSizeUpdated':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							device: $mdgriffith$elm_ui$Element$classifyDevice(winSize),
							windowSize: winSize
						}),
					$elm$core$Platform$Cmd$none);
			case 'LocationChange':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							measurements: _List_Nil,
							myLocation: $author$project$Model$iniMyLocation,
							refLocation: _Utils_Tuple2(ort, position)
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
			...
			case 'ShowPage':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{activePage: page}),
					_Utils_eq(page, $author$project$Model$MeasurePage) ? $elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$PortOl$setOlConfig(
								$author$project$Main$buildOlMapConfig(model))
							])) : $elm$core$Platform$Cmd$none);
			case 'ToggleShowDistance':
				var oldSettings = model.settings;
				var toggleCheckDist = !oldSettings.checkDistance;
				var newSettings = _Utils_update(
					oldSettings,
					{checkDistance: toggleCheckDist});
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'RefImgSrcChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{refImgSrc: imgSrc}),
					$elm$core$Platform$Cmd$none);
			case 'RefDescriptionChanged':
				var mdDescription = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{refMdDescription: mdDescription}),
					$elm$core$Platform$Cmd$none);
			...
			case 'RefLocationEdit':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							refEast: refSelected.east,
							refId: refSelected.refId,
							refImgSrc: refSelected.imgUrl,
							refMdDescription: refSelected.mdDescription,
							refNorth: refSelected.north,
							refTitle: refSelected.title,
							settings: $author$project$Main$toggleAddReference(model.settings)
						}),
					$elm$core$Platform$Cmd$none);
			...
			default:
				...
				var newLocations = function () {
					var kvPairs = A2(
						$elm$core$List$map,
						function (p) {
							return _Utils_Tuple2(p.refId, p);
						},
						getStoredPositions);
...
var $author$project$Views$Styles$sectionRowStyle = _List_fromArray(
	[
		...
		{
			bottom: $author$project$Views$Styles$paddingScale(1),
			left: 10,
			right: 0,
			top: $author$project$Views$Styles$paddingScale(5)
		}),
...
var $author$project$Views$Measurements$showDistances = function (model) {
	...
	var pos = model.refLocation.b;
	var lastXMeasurements = A2($elm$core$List$take, model.settings.meanMeasures, model.measurements);
	var getNorth = A3(
		$elm$core$List$foldl,
		function (a) {
			return $elm$core$Basics$add(a.north);
			...
			[
				...
				_List_fromArray(
					[
						...
						'Mittlere Distanz (' + ($elm$core$String$fromInt(model.settings.meanMeasures) + ' Messungen)')),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$paddingEach(
								{bottom: 10, left: 0, right: 0, top: 15}),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
							]),
						A2(
							$mdgriffith$elm_ui$Element$el,
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Views$Styles$valueStyle,
						$mdgriffith$elm_ui$Element$text(
							evalPos(myLocation.accuracyPos)))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$author$project$Views$Styles$valueStyle,
						$mdgriffith$elm_ui$Element$text(
							evalAlti(myLocation.accuracyAltitude)))
					]))
			]));
};
...
var $author$project$Views$Measurements$viewCoordRow = function (model) {
	...
	var h = function () {
		var _v1 = model.myLocation.height;
		if (_v1.$ === 'Just') {
			var a = _v1.a;
			return A2(
				$cuducos$elm_format_number$FormatNumber$format,
	...
	var alti = function () {
		var _v0 = model.myLocation.altitude;
		if (_v0.$ === 'Just') {
			var altitude = _v0.a;
			return A2(
				$cuducos$elm_format_number$FormatNumber$format,
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Views$Styles$valueStyle,
						$mdgriffith$elm_ui$Element$text(
							evalSpeed(myLocation.movingSpeed)))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						$author$project$Views$Styles$valueStyle,
						$mdgriffith$elm_ui$Element$text(
							evalDirection(myLocation.movingDegrees)))
					]))
			]));
};
...
var $author$project$Views$Measurements$showMeasurements = function (model) {
	var showRefPoint = model.settings.checkDistance ? _List_fromArray(
		[
			$author$project$Views$Helpers$sectionTitle('Referenzpunkt - ' + model.refLocation.a),
			$author$project$Views$Measurements$showRef(model)
		]) : _List_Nil;
	var showDist = model.settings.checkDistance ? _List_fromArray(
		[
			$author$project$Views$Helpers$sectionTitle('Distanz zum Referenzpunkt - ' + model.refLocation.a),
	...
	return _Utils_ap(
		...
		_Utils_ap(
			...
			_Utils_ap(
				_List_fromArray(
					[
						$author$project$Views$Measurements$viewError(model.error),
						$author$project$Views$OlMap$showOlMap(model),
						$author$project$Views$Helpers$sectionTitle('Genauigkeitsangabe des Gerätes'),
						$author$project$Views$Measurements$viewAccuracy(model.myLocation),
						$author$project$Views$Helpers$sectionTitle('Zeitpunkt der letzten Messung'),
						A2($author$project$Views$Measurements$viewTimestamp, model.myLocation.timestamp, model.timezone),
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Views$Measurements$viewMovement(model.myLocation)
						])))));
};
var $mdgriffith$elm_ui$Element$none = $mdgriffith$elm_ui$Internal$Model$Empty;
var $author$project$Model$ToggleShowDistance = {$: 'ToggleShowDistance'};
...
var $author$project$Model$ExportReferences = {$: 'ExportReferences'};
var $author$project$Model$ImportRequested = {$: 'ImportRequested'};
var $author$project$Model$ToggleAddReference = {$: 'ToggleAddReference'};
...
var $author$project$Views$Settings$showAddReferceForm = function (model) {
	...
	var imgUrl = $elm$core$String$isEmpty(model.refImgSrc) ? $author$project$Views$Helpers$imgUrlFromWms(
		_Utils_Tuple2(model.refEast, model.refNorth)) : model.refImgSrc;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Input$focusedOnLoad, inputStyle),
				{
					...
					onChange: $author$project$Model$RefTitleChanged,
				...
				inputStyle,
				{
					...
					onChange: $author$project$Model$RefDescriptionChanged,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
				...
				_List_fromArray(
					[
						...
						inputStyle,
						{
							...
							onChange: $author$project$Model$RefEastChanged,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('Ost-Koordinate'))),
							text: $elm$core$String$fromFloat(model.refEast)
						}),
						A2(
						$mdgriffith$elm_ui$Element$Input$text,
						inputStyle,
						{
							...
							onChange: $author$project$Model$RefNorthChanged,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
									$mdgriffith$elm_ui$Element$text('Nord-Koordinate'))),
							text: $elm$core$String$fromFloat(model.refNorth)
						})
					])),
				A2(
				$mdgriffith$elm_ui$Element$Input$text,
				...
				{description: model.refTitle, src: imgUrl}),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
...
var $author$project$Model$winti = _Utils_Tuple2(
	'2Winterthur',
	{altitude: 475.2, east: 2699109, fix: true, imgUrl: './img/Winterthur.jpg', latitude: 47.507765, longitude: 8.7542368, mdDescription: 'Weitere Web-Applikationen auf der [landing page](https://szinggeler.github.io/ "landing page")', north: 1262721, refId: '2Winterthur', title: 'Test-Kontrollpunkt für mobile Geräte beim Schleifstein... ;-)'});
var $author$project$Views$Settings$showReferceLocations = F2(
	function (model, listRefs) {
		...
		var selected = function (ort) {
			return _Utils_eq(ort, model.refLocation.a) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$html(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text(pos.title)
									]))
							])),
						pos.fix ? $mdgriffith$elm_ui$Element$none : showEditButtons(ort)
					]));
		};
		var buildRows = A2(
			$elm$core$List$map,
...
var $author$project$Views$Settings$showEditReference = function (model) {
	var editMode = (model.refId === '') ? 'hinzufügen' : 'bearbeiten';
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		model.settings.addingReference ? _List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Views$Settings$showDistance(model.settings.checkDistance),
				model.settings.checkDistance ? $author$project$Views$Settings$showEditReference(model) : $mdgriffith$elm_ui$Element$none
			]));
};
...
var $author$project$View$getViewContent = function (model) {
	...
	var imgUrl = $elm$core$String$isEmpty(refPos.imgUrl) ? $author$project$Views$Helpers$imgUrlFromWms(
		_Utils_Tuple2(refPos.east, refPos.north)) : refPos.imgUrl;
	var content = A2(
				...
				case 'AboutPage':
					return _List_fromArray(
						[
							...
							{description: 'Bild' + (' des Referenz-Punktes ' + refName), src: imgUrl})
						]);
				case 'MeasurePage':
...
var $author$project$Views$Styles$myFocusStyle = {
	backgroundColor: $elm$core$Maybe$Just($author$project$Views$Styles$white),
	borderColor: $elm$core$Maybe$Just($author$project$Views$Styles$lightGray),
			...
			[
				...
				_List_fromArray(
					[
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$Views$Styles$tabStyle(
							_Utils_eq(model.activePage, $author$project$Model$AboutPage)),
						_List_fromArray(
							[
								showTab($author$project$Model$AboutPage)
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$Views$Styles$tabStyle(
							_Utils_eq(model.activePage, $author$project$Model$MeasurePage)),
						_List_fromArray(
							[
								showTab($author$project$Model$MeasurePage)
							])),
						A2(
						$mdgriffith$elm_ui$Element$row,
						$author$project$Views$Styles$tabStyle(
							_Utils_eq(model.activePage, $author$project$Model$SettingsPage)),
						_List_fromArray(
							[
								showTab($author$project$Model$SettingsPage)
							]))
					]))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						{name: 'Montserrat', url: 'https://fonts.googleapis.com/css?family=Montserrat:300'}),
