...
var author$project$Views$Settings$showReferceLocations = function (model) {
	...
	var getRef = function (ort) {
		var _n2 = A2(elm$core$Dict$get, ort, model.locations);
		if (_n2.$ === 'Just') {
			var pos = _n2.a;
				...
				_List_fromArray(
					[
						...
						author$project$Views$Styles$tabStyle(
							_Utils_eq(page, author$project$Model$AboutPage)),
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$row,
						author$project$Views$Styles$tabStyle(
							_Utils_eq(page, author$project$Model$MeasurePage)),
						_List_fromArray(
							[
						...
						mdgriffith$elm_ui$Element$row,
						author$project$Views$Styles$tabStyle(
							_Utils_eq(page, author$project$Model$SettingsPage)),
						_List_fromArray(
							[
...
var author$project$View$view = function (model) {
	return A3(
		...
		A2(
			...
			A2(
				elm$core$List$cons,
				author$project$View$showHeader(model.activePage),
